<nav class="sidebar sidebar-offcanvas" id="sidebar">
  <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
    <a class="sidebar-brand brand-logo" href="{{url('home')}}"><span class="text-primary">One</span>-Health</a></a>
    <a class="sidebar-brand brand-logo-mini" href="{{url('home')}}"><span class="text-primary">O</span>-H</a></a>
  </div>
  <ul class="nav">
    ...
    <li class="nav-item menu-items">
      <a class="nav-link" href="{{url('showproduct')}}">
        ...
        <span class="menu-title">Show Medicine</span>
      </a>
    </li>
